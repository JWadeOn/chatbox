  ...
  return (
    <div className="flex h-full w-64 flex-col border-r border-gray-200 bg-gray-50">
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {conversations.length === 0 && <p className="p-3 text-center text-xs text-gray-400">No conversations yet</p>}
        {conversations.map((conv) => (
          <button
            ...
            className={`mb-1 w-full rounded-lg px-3 py-2 text-left text-sm transition-colors ${
              activeId === conv.id ? 'bg-blue-100 text-blue-800' : 'text-gray-700 hover:bg-gray-100'
            }`}
          >
